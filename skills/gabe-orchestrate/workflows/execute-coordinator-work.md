...
* do not personally edit application code from the root coordinator when acting from human Gabe's direction

* do not perform code reviews or spawn code reviewers from the root coordinator

* assign application-code implementation and code-review ownership to a durable implementer lane
