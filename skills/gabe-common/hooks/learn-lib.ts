...
export function formatLearnFollowup(
  ...
  return [
    ...
    "",
    "Reflect on human corrections, skill gaps, and weak or ambiguous rules from this turn.",
    "If a durable lesson exists, update implement and/or review (and shared engineering-rules when both need the same MUST) via update-living-skills.",
    "If nothing durable must change, mark nothing-to-learn and stop.",
    `When done, the MDScript must write status=satisfied for loop ${loopCount} to:`,
    passPath,
    "",
