...
- `self-review` blind eng-* lanes selected in `workflows/select-review-lanes.md`
- `self-implement` construction packs selected in `skills/self-implement/workflows/select-implementation-rules.md` (`impl-*` entrypoints under `skills/self-implement/workflows/engineering-rules/`)
