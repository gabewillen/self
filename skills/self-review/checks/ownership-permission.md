...
* inspect that user, assistant, automation, worker, reviewer, and author boundaries are preserved
...
* run [Resolve GitLab Sudo Alias](../../self-common/workflows/gitlab-sudo-alias.md#resolve-gitlab-sudo-alias) with `{{self_role}}` set to `reviewer`
