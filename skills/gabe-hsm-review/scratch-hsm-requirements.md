...
**Goal of the future skill:** `gabe-hsm-review` — MDScript skill that adversarially reviews HSM/SML work against Gabe’s hard rules across `hsm.go` / multi-language HSM DSL, grantt, mjw-style usage, and emel.cpp SML actor rules.
