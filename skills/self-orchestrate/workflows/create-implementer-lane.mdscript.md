...
* assign lane identity with [Assign Lane Identity](../../self-common/workflows/lane-identity.mdscript.md#assign-lane-identity)
* create or resume the implementer with `model: {{required_model}}` and `reasoning: {{required_reasoning}}`
* [Ensure Implementer Task And Goal](#ensure-implementer-task-and-goal)
...
* run [Write Goal MDScript](../../self-common/workflows/goal-mdscript.mdscript.md#write-goal-mdscript) when the implementer lane will be resumed, monitored, or handed across agents
