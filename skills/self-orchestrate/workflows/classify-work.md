...
* if `~/.agents/projects/{{project_name}}/tasks` exists
  ...
  * run [Classify File Workstream Fanout](../../self-common/workflows/file-task-comments.md#classify-file-workstream-fanout) before choosing a direct implementer lane
  * run [Write Goal MDScript](../../self-common/workflows/goal-mdscript.md#write-goal-mdscript) before child-lane fanout or monitor ownership
