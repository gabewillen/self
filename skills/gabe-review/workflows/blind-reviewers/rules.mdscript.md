...
* set `{{signoff_path}}` to `{{review_signoff_dir}}/signoff-reviewer-rules.mdscript.md` when `{{review_signoff_dir}}` is set, otherwise `{{run_dir}}/signoff-reviewer-rules.mdscript.md` when `{{run_dir}}` is set, otherwise `{{artifact_dir}}/signoff-reviewer-rules.mdscript.md`
