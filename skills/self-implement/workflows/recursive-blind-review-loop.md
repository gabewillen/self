...
* if code changed
  ...
  * run [Resolve Review Baseline](../../self-review/workflows/rolling-code-review.md#resolve-review-baseline)
...
* run [Sync File Task Proof State](../../self-common/workflows/file-task-comments.md#sync-file-task-proof-state)
...
* run [Select Configured Model And Reasoning](../../self-common/workflows/model-reasoning-contract.md#select-configured-model-and-reasoning) with `{{self_role}}` set to `reviewer` before spawning lane reviewers
...
* run [Select Review Lanes](../../self-review/workflows/select-review-lanes.md#select-review-lanes)
...
* if `{{review_cycle}}` is `recursive-code`
  * run [Record Completed Review Snapshot](../../self-review/workflows/rolling-code-review.md#record-completed-review-snapshot)
