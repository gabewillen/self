...
* include any exact orchestrator continuation jump the orchestrator should execute, such as `/mdscript-exec {{skills_root}}/self-orchestrate/workflows/mr-comment-watcher.mdscript.md#create-mr-comment-watcher`, `/mdscript-exec {{skills_root}}/self-orchestrate/workflows/handle-worker-exec-jump.mdscript.md#handle-worker-exec-jump`, `/mdscript-exec {{skills_root}}/self-orchestrate/workflows/monitor-implementer-lane.mdscript.md#monitor-implementer-lane`, or `/mdscript-exec {{skills_root}}/self-orchestrate/workflows/merge-or-close-decision.mdscript.md#handle-merge-or-close-decision`
