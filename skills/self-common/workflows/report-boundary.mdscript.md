...
* run [Cleanup Created Threads](thread-cleanup.mdscript.md#cleanup-created-threads) for any chat thread, child lane thread, worker thread, reviewer thread, or subagent this lane created
...
* run [Cleanup Created Threads](thread-cleanup.mdscript.md#cleanup-created-threads) for created terminal or superseded chat threads
