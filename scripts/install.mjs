...
const REQUIRED_SKILL_ASSETS = {
  ...
  "self-review": [
    ...
    "workflows/neutral-review-packet.mdscript.md",
...
// HSM pack (folded into self-review; not a top-level skill)
  ...
  "self-common": [
    "workflows/goal-mdscript.mdscript.md",
    "workflows/return-script.mdscript.md",
    "workflows/mdscript-artifact.mdscript.md",
    "templates/running-log.mdscript.md",
    "templates/review-packet.mdscript.md",
  ...
  "self-troubleshoot": [
    ...
    "workflows/apply-fix-and-rerun.mdscript.md",
  ],
};
